...
chick_burger_option_2_description = "Which came first... Who cares! You get both on this one!"
chick_burger_option_3_description = "As fiery as Mount Etna, if your up for the challenge??"
vegetarian_option_1_description = "For those of you who like to be PC, we have a burger without the burger on it"
...
chick_burger_option_1 = Burgers("Our Extra Special Fowl Burger", 15, chick_burger_option_1_description)
chick_burger_option_2 = Burgers("The Chicken Or The Egg??", 20, chick_burger_option_2_description)
chick_burger_option_3 = Burgers("Mount Etna Burger", 25, chick_burger_option_3_description)
...
not_burger_option_5_description = "For those who like a bit of the garden on their plate"
...
#Instantiate Menu
not_burger_option_1 = Not_Burgers("Kays Fried Chicken (K.F.C)", 15, not_burger_option_1_description)
not_burger_option_2 = Not_Burgers("Poach Of The Day", 20, not_burger_option_2_description)
not_burger_option_3 = Not_Burgers("Smurf & Turf", 25, not_burger_option_3_description)
not_burger_option_4 = Not_Burgers("Thatched Cottage Pie", 15, not_burger_option_4_description)
...
dessert_option_5_description = "As the name suggests its just a melba but not very peachy"
...
dessert_option_4 = Desserts("Ice Cream For Comfort Eating", 15, dessert_option_4_description)
dessert_option_5 = Desserts("Not Very Peachy Melba", 20, dessert_option_5_description)
dessert_option_6 = Desserts("Freshly Laid Tarmac Cake", 25, dessert_option_6_description)
...
milkshake_option_4_description = "Mega Chocolate Milkshake but white (we were running out of ideas)"
...
milkshake_option_8_description = "Who doesn't like Jamie Dodgers, broken up in a milkshake "
milkshake_option_9_description = "Bakewell Tart flavoured milkshake obviously"

# Instantiate Menu
milkshake_option_1 = Milkshakes("Cheesecake Milkshake", 15, milkshake_option_1_description)
milkshake_option_2 = Milkshakes("Flurry Berry Milkshake", 20, milkshake_option_2_description)
milkshake_option_3 = Milkshakes("Mega Chocolate Milkshake", 25, milkshake_option_3_description)
milkshake_option_4 = Milkshakes("White Chocolate Wonderland Milkshake", 15, milkshake_option_4_description)
milkshake_option_5 = Milkshakes("Oreos Forever Milkshake", 20, milkshake_option_5_description)
milkshake_option_6 = Milkshakes("The Big Brownie Milkshake", 25, milkshake_option_6_description)
milkshake_option_7 = Milkshakes("Flakey Wakey Milkshake", 15, milkshake_option_7_description)
